    ...
    <div class="catalog-left">
        ...
        $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "SECTION_ID" => "",
                "SECTION_ID_NEW" => \Kosmos\Multisite::getCatalogSections(),
                "SECTION_CODE" => "",
        ...
        <?
        $arIds = \Kosmos\Discount::getFull(['IBLOCK_TYPE' => 'catalog', 'IBLOCK_ID' => 2]);
        $GLOBALS["arrFilter"]['SECTION_ID']= \Kosmos\Multisite::getCatalogSections();
        $GLOBALS["arrFilter"]['ID']= $arIds;
        $GLOBALS["arrFilter"]['PROPERTY_SALON_VALUE']= false;
       /* $GLOBALS["arrFilter"] = [
            "SECTION_ID" => \Kosmos\Multisite::getCatalogSections(),
            'ID' => $arIds,
            'PROPERTY_SALON_VALUE' => false
        ];*/
       ?>
