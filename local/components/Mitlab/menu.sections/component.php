...
if($this->StartResultCache())
{
	...
	else
	{
		...
		$currentSiteID = \Kosmos\Multisite::getCurrentSite(CATALOG_PROPERTY_SITE_ID);
		...
		while($arSection = $rsSections->GetNext())
		{
			...
			if($arSection["DEPTH_LEVEL"] == 1)
			{
				if(empty($arSection[CATALOG_PROPERTY_SITE_CODE]) || in_array($currentSiteID, $arSection[CATALOG_PROPERTY_SITE_CODE]))
				{
					$arResult["SECTIONS"][] = array(
						"ID" => $arSection["ID"],
						...
						"UF_HIDE_MENU"=> $arSection["UF_HIDE_MENU"]
					);
