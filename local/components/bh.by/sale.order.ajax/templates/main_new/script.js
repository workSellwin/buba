...
function changeTime() {
    ...
    var selectTime_40 = $('select[name="ORDER_PROP_40"]'),
        selectTimeOption_40 = selectTime_40.find("option");
        ...
        if (selectDate.getDay() == 0) {
            ...
            if(dostavka_id == 43){
                ...
                if (curDate.getHours() > 10 && curDate.getHours() < 16) {
                    $(selectTimeOption_40[0]).attr('disabled', true);
                    $(selectTimeOption_40[1]).attr('disabled', true);
                    $(selectTimeOption_40[2]).attr('disabled', true);
                    $(selectTimeOption_40[3]).attr('disabled', true);
                    $(selectTimeOption_40[4]).attr('disabled', true);
                    $(selectTimeOption_40[5]).attr('disabled', true);
                ...
                if (curDate.getHours() > 16) {
                    ...
                    $(selectTimeOption_40[4]).attr('disabled', true);
                    $(selectTimeOption_40[5]).attr('disabled', true);
                    $(selectTimeOption_40[6]).attr('disabled', true);
                    $(selectTimeOption_40[7]).attr('disabled', true);
                    $(selectTimeOption_40[8]).attr('disabled', true);
                    $(selectTimeOption_40[9]).attr('disabled', true);
            ...
            */
            ...
            if(dostavka_id == 43){
                $(selectTimeOption_40[0]).attr('disabled', false);
                $(selectTimeOption_40[1]).attr('disabled', false);
                $(selectTimeOption_40[2]).attr('disabled', false);
                $(selectTimeOption_40[3]).attr('disabled', false);
                $(selectTimeOption_40[4]).attr('disabled', false);
                $(selectTimeOption_40[5]).attr('disabled', false);
                $(selectTimeOption_40[6]).attr('disabled', false);
                $(selectTimeOption_40[7]).attr('disabled', false);
                $(selectTimeOption_40[8]).attr('disabled', false);
                $(selectTimeOption_40[9]).attr('disabled', false);
            }
