...
Class Yauheni_discount extends CModule
{
    var $MODULE_ID = "yauheni.discount";
    var $MODULE_VERSION;
    ...
    function Yauheni_discount()
    {
        ...
        $this->MODULE_NAME = GetMessage("VISUAL_WORK_DISCOUNTS_ONLINER_MODULE_NAME");
    ...
    function InstallFiles()
    {
        ...
        CopyDirFiles($this->GetPath() . "/install/admin/discount_start.php", $_SERVER["DOCUMENT_ROOT"] . "/bitrix/admin/discount_start.php", true);
