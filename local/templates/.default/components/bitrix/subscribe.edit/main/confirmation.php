...
<tr valign="top">
	<td width="40%">
		...
		<input type="text" name="CONFIRM_CODE" value="<?echo $arResult["REQUEST"]["CONFIRM_CODE"];?>" class="field" /></p>
...
<tfoot><tr><td colspan="2"><input type="submit" class="btn btn_black" name="confirm" value="<?echo GetMessage("subscr_conf_button")?>" /></td></tr></tfoot>
</table>
