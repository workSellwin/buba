...
<style>
    #BOX_PRODUCT_BUY_JS .prod-price:before {
        border: none;
    }
    #BOX_PRODUCT_BUY_JS .related__hiden{
        margin-top: 10px;
    }
...
<div class="related__item">
    ...
    <div class="related__hiden" style="display: block">
        <div class="prod-price" data-entity="price-block">
            ...
            ?>
            <div class="prod-price__new" data-id="<?=$item['ID']?>" id="<?= $itemIds['PRICE'] ?>">
                <?
                if (!empty($price)) {
                    //TODO добавляем НДС к цене 77777
                    if ($price['PRICE_TYPE_ID'] == 2) {
        ...
        <div class="" data-entity="buttons-block" style="display: none">
