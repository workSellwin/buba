...
<a class="prod-img" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>" data-entity="image-wrapper">
	<span id="<?=$itemIds['PICT_SLIDER']?>">
		<img src="<?=(!empty($item['DETAIL_PICTURE']['SRC']))?$item['DETAIL_PICTURE']['SRC']:SITE_TEMPLATE_PATH."/components/bitrix/catalog.section/cat/images/no_photo.png"?>" alt="<?=$imgTitle?>" id="<?=$itemIds['PICT']?>">
	</span>
</a>
