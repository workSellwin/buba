...
<div class="bx-auth">
	...
	<form method="post" class="authorize-form" action="<?=$arResult["AUTH_FORM"]?>" name="bform">
		...
		<div class="field-wrp">
			<input type="text" name="USER_LOGIN" maxlength="50" value="<?=$arResult["LAST_LOGIN"]?>" class="field" />
		</div>

		<label for=""><?=GetMessage("AUTH_CHECKWORD")?></label>
		<div class="field-wrp">
			<input type="text" name="USER_CHECKWORD" maxlength="50" value="<?=$arResult["USER_CHECKWORD"]?>" class="field" />
		</div>

		<label for=""><?=GetMessage("AUTH_NEW_PASSWORD_REQ")?></label>
		<div class="field-wrp">
			<input type="password" name="USER_PASSWORD" maxlength="50" value="<?=$arResult["USER_PASSWORD"]?>" class="field" autocomplete="off" />
		...
		<div class="field-wrp">
			<input type="password" name="USER_CONFIRM_PASSWORD" maxlength="50" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" class="field" autocomplete="off" />
		</div>
