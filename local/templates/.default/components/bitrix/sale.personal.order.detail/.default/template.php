...
if ($arParams['GUEST_MODE'] !== 'Y')
{
	...
	Asset::getInstance()->addCss("/local/templates/main/components/bitrix/sale.order.payment.change/.default/style.css");
}
$this->addExternalCss(SITE_TEMPLATE_PATH."/css/bootstrap.css");
...
else
{
	...
	<div class="container-fluid sale-order-detail">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-general">
			...
			<div class=" sale-order-detail-about-order">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-about-order-inner-container">
							<div class="">
								...
								<div class="col-md-<?=($arParams['GUEST_MODE'] !== 'Y') ? 2 : 4?> col-sm-6 sale-order-detail-about-order-inner-container-price">
									...
									<div class="hide gmi-nds sale-order-detail-about-order-inner-container-price-title">
										Сумма с НДС:
									</div>
									<div class="hide gmi-nds sale-order-detail-about-order-inner-container-price-detail">
										<?= $arResult["GMI_ALL_TOTAL_SUM_NDS_FORMAT"]?>
									</div>
								</div>
								<?
								if ($arParams['GUEST_MODE'] !== 'Y')
			...
			<?/*<div class="bx-row sale-order-detail-payment-options">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-inner-container">
							...
							<div class="bx-row">
								<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods-container">
									...
									{
										?>
										<div class="bx-row payment-options-methods-row">
											<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods">
												<div class="bx-row sale-order-detail-payment-options-methods-information-block">
												...
												{
													?>
													<div class="bx-row sale-order-detail-payment-options-methods-template col-md-12 col-sm-12 col-xs-12">
			...
			*/?>
			...
			<div class=" sale-order-detail-payment-options-order-content">
									...
									<div style="width: 100%; overflow-x: auto; overflow-y: hidden;">
										<div class="sale-order-detail-order-item-table">
											<div class="sale-order-detail-order-item-tr hidden-sm hidden-xs">
												...
												<div class="hide gmi-nds sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right" style="padding-bottom: 5px;">
													<div class="sale-order-detail-order-item-td-title">
														Сумма с НДС
													</div>
												</div>
											...
											foreach ($arResult['BASKET'] as $basketItem)
											{
												...
												<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
													...
													<div class="hide gmi-nds sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
														<div class="sale-order-detail-order-item-td-title col-xs-7 col-sm-5 visible-xs visible-sm">Сумма с НДС</div>
														<div class="sale-order-detail-order-item-td-text">
															<strong class="bx-price all"><?=$basketItem['GMI_SUM_NDS_FORMAT']?></strong>
														</div>
													</div>
												</div>
												<?
			...
			<div class=" sale-order-detail-total-payment">
				<div class="col-md-7 col-md-offset-5 col-sm-12 col-xs-12 sale-order-detail-total-payment-container">
					<div class="gmi-flex">
						<ul class="col-md-8 col-sm-6 col-xs-6 sale-order-detail-total-payment-list-left">
							...
							<li class="hide gmi-nds sale-order-detail-total-payment-list-left-item">Итого с НДС:</li>
						</ul>
						<ul class="col-md-4 col-sm-6 col-xs-6 sale-order-detail-total-payment-list-right">
							...
							<li class="hide gmi-nds sale-order-detail-total-payment-list-right-item"><?=$arResult['GMI_ALL_TOTAL_SUM_NDS_FORMAT']?></li>
						</ul>
					</div>
				</div>
			</div>
