...
<div class="<?=($arParams["GMI_FLAG"]!= "Y")?"prod-other__slider carousel hide ":"viewed-prods carousel hide"?>" data-entity="<?=$containerName?>">
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
            ...
            <?if($item['PRODUCT']['QUANTITY'] > 0):?>
                <div class="prod-other__slider-item <?//=$rowData['CLASS']?>" data-entity="items-row" >
                    <?
                    $item = reset($rowItems);
