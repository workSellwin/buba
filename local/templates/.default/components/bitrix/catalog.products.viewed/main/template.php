...
?>
<div class='viewed-prods-wrp' data-entity="parent-container">
<?if(!empty($arResult['ITEMS'])):?>
<div data-entity="header" data-showed="false" style="" class="prod-other h2">
	ПРОСМОТРЕННЫЕ ТОВАРЫ
</div>
<div class="loader show"></div>
<?endif?>
<div class="viewed-prods carousel hide" data-entity="<?=$containerName?>">
	<?
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			?>
			<div class="viewed-prods__item" data-entity="items-row">
				<?
				$item = reset($rowItems);
